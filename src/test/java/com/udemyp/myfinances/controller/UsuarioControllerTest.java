...
public class UsuarioControllerTest {
    ...
    @Test
    public void deveRetornarErroDeAutenticacao() throws Exception{
    ...
    @Test
    public void deveSalvarNovoUsuario() throws Exception{
    ...
    @Test
    public void deveLancarErroAoSalvarUsuarioInvalido() throws Exception{
